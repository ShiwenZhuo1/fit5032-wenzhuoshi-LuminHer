  ...
  <div class="container my-4">
    <div class="d-flex align-items-center justify-content-between mb-3">
      ...
      <div class="btn-group btn-group-sm" role="group" aria-label="Units">
        <button type="button" class="btn" :class="units==='metric'?'btn-dark':'btn-outline-dark'"
                @click="setUnits('metric')">Metric (cm / kg)</button>
        <button type="button" class="btn" :class="units==='imperial'?'btn-dark':'btn-outline-dark'"
                @click="setUnits('imperial')">Imperial (ft/in / lb)</button>
      </div>
    </div>
            ...
            <div class="flex-grow-1 ms-lg-4" style="min-width:220px;">
              <div class="progress" style="height:6px;">
                <div class="progress-bar" role="progressbar"
                     ...
                     :aria-valuenow="progress" aria-valuemin="0" aria-valumax="100"></div>
              </div>
              ...
              <div class="row g-3">
                <div class="col-12 col-md-4">
                  ...
                  <div class="d-flex gap-3">
                    <label class="form-check"><input class="form-check-input" type="radio" value="female" v-model="form.sex" @change="validateSex(true)"> <span class="form-check-label">Female</span></label>
                    <label class="form-check"><input class="form-check-input" type="radio" value="male" v-model="form.sex" @change="validateSex(true)"> <span class="form-check-label">Male</span></label>
                    <label class="form-check"><input class="form-check-input" type="radio" value="other" v-model="form.sex" @change="validateSex(true)"> <span class="form-check-label">Other</span></label>
                  </div>
                ...
                <div class="col-12 col-md-4">
                  ...
                  <input type="date" class="form-control" :class="{'is-invalid': errors.dob}"
                         v-model="form.dob" @change="validateDOB(true)" />
                ...
                <div class="col-12 col-md-4">
                  ...
                  <template v-if="units==='metric'">
                    <div class="input-group">
                      <input type="number" min="120" max="210" class="form-control"
                             :class="{'is-invalid': errors.height}"
                             v-model.number="form.height_cm" @input="validateHeight(false)" @blur="validateHeight(true)" />
                      <span class="input-group-text">cm</span>
                    </div>
                  </template>
                  <template v-else>
                    <div class="input-group">
                      <input type="number" min="3" max="7" class="form-control" v-model.number="height_ft" @input="syncHeightFromImperial"><span class="input-group-text">ft</span>
                      <input type="number" min="0" max="11" class="form-control" v-model.number="height_in" @input="syncHeightFromImperial"><span class="input-group-text">in</span>
                    </div>
                  </template>
                ...
                <div class="col-12 col-md-4">
                  ...
                  <div class="input-group">
                    <input type="number" class="form-control" :class="{'is-invalid': errors.wtNow}"
                           v-model.number="weight_current_ui" @input="syncCurrentWeight" @blur="validateWeights(true)" />
                ...
                <div class="col-12 col-md-4">
                  ...
                  <div class="input-group">
                    <input type="number" class="form-control" :class="{'is-invalid': errors.wtGoal}"
                           v-model.number="weight_goal_ui" @input="syncGoalWeight" @blur="validateWeights(true)" />
                    <span class="input-group-text">{{ units==='metric' ? 'kg' : 'lb' }}</span>
                  </div>
                ...
                <div class="col-12 col-md-4">
                  ...
                  <input type="date" class="form-control" :class="{'is-invalid': errors.targetDate}"
                         v-model="form.target_date" @change="validateTargetDate(true)" />
            ...
            <div v-else-if="step===1">
              <div class="row g-3">
                <div class="col-12 col-md-6">
                  ...
                  <select class="form-select" :class="{'is-invalid': errors.activity}"
                          v-model="form.activity" @change="validateActivity(true)">
              ...
              <div class="row g-3">
                <div class="col-12 col-md-4">
                  ...
                  <select class="form-select" v-model="form.diet_style">
                    ...
                    <option>Balanced</option><option>High-Protein</option><option>Mediterranean</option>
                    <option>Vegetarian</option><option>Vegan</option><option>Low-Carb</option>
                ...
                <div class="col-12 col-md-8">
                  ...
                  <input type="text" class="form-control" placeholder="e.g., dairy, nuts, alcohol"
                         v-model="allergyInput" @change="syncAllergies" />
                ...
                <div class="col-6 col-md-3">
                  ...
                  <select class="form-select" v-model="form.budget">
                    <option value="">--</option><option>Free</option><option>$</option><option>$$</option><option>$$$</option>
                  </select>
                </div>
                <div class="col-6 col-md-3">
                  <label class="form-label">Cooking time</label>
                  <select class="form-select" v-model="form.cook_time">
                    <option value="">--</option><option>≤10m</option><option>≤20m</option><option>≤30m</option><option>30m+</option>
                  </select>
                </div>
                <div class="col-6 col-md-3">
            ...
            <div v-else-if="step===3">
              <div class="row g-3">
                <div class="col-12 col-md-4">
                  ...
                  <select class="form-select" :class="{'is-invalid': errors.goal}" v-model="form.goal" @change="validateGoal(true)">
                    <option value="" disabled>-- Select --</option>
                    <option>Fat loss</option><option>Recomp</option><option>Strength</option>
                  </select>
                ...
                <div class="col-6 col-md-2">
                  ...
                  <select class="form-select" v-model="form.location">
                    <option value="">--</option><option>Gym</option><option>Home</option><option>Outdoor</option>
                  </select>
                </div>
                <div class="col-12 col-md-4">
              ...
              <div class="row g-3">
                <div class="col-12 col-md-4">
                  ...
                  <select class="form-select" v-model="form.reminders.weigh_in">
                    <option value="">Off</option><option>Daily</option><option>Weekly</option>
                  </select>
                </div>
...
function nextStep(){
  if (validateStep(step.value)) step.value = Math.min(steps.length - 1, step.value + 1)
}
...
const strictnessLabel = computed(() => {
  ...
  if (s >= .8) return 'Very strict'
  if (s >= .6) return 'Strict'
  if (s >= .4) return 'Balanced'
  if (s >= .2) return 'Flexible'
...
/* Save to localStorage and go back to list */
