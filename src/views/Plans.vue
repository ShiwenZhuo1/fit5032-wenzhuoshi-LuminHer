<template>
  <div class="container my-4">
    <h2 class="mb-4 text-center">Plan Setup</h2>
    ...
    <form @submit.prevent="submitForm" novalidate>
      <!-- 1) BASICS -->
      <div class="card mb-4">
        <div class="card-header fw-bold">1) Basics</div>
        <div class="card-body">
          <div class="row g-3">
            <!-- Sex -->
              ...
              <div class="d-flex gap-3">
                ...
                <div class="form-check">
                  <input
                    ...
                    id="sexO"
                  />
                  <label for="sexO" class="form-check-label">Other</label>
                </div>
              </div>
              <div v-if="errors.sex" class="invalid-feedback d-block">
                {{ errors.sex }}
              </div>
            </div>
            ...
            <div class="col-12 col-md-4">
              ...
              <div v-if="errors.height" class="invalid-feedback d-block">
                {{ errors.height }}
              </div>
            </div>
            ...
            <div class="col-12 col-md-4">
              <label class="form-label"
                >Current weight <span class="text-danger">*</span></label
              >
              <div class="input-group">
                <input
                  type="number"
              ...
              <div v-if="errors.wtNow" class="invalid-feedback d-block">
                {{ errors.wtNow }}
              </div>
            </div>
            ...
            <div class="col-12 col-md-4">
              <label class="form-label"
                >Goal weight <span class="text-danger">*</span></label
              >
              <div class="input-group">
                <input
                  type="number"
              ...
              <div v-if="errors.wtGoal" class="invalid-feedback d-block">
                {{ errors.wtGoal }}
              </div>
            </div>
            ...
            <div class="col-12 col-md-4">
              ...
              <div v-if="errors.targetDate" class="invalid-feedback d-block">
                {{ errors.targetDate }}
              </div>
            </div>
          </div>
      ...
      <!-- 2) ACTIVITY -->
      <div class="card mb-4">
        <div class="card-header fw-bold">2) Activity & lifestyle</div>
        <div class="card-body">
          <div class="row g-3">
            <div class="col-12 col-md-6">
              <label class="form-label"
                >Daily activity level <span class="text-danger">*</span></label
              >
              <select
                class="form-select"
              ...
              <div v-if="errors.activity" class="invalid-feedback d-block">
                {{ errors.activity }}
              </div>
            </div>
            <div class="col-6 col-md-2">
              ...
              <input
                ...
                max="7"
                class="form-control"
                v-model.number="form.workout_days"
              />
            </div>
            <div class="col-6 col-md-2">
      ...
      <!-- 3) NUTRITION -->
      <div class="card mb-4">
        <div class="card-header fw-bold">3) Nutrition preferences</div>
        <div class="card-body">
          <div class="row g-3">
            <div class="col-12 col-md-4">
            ...
            <div class="col-12 col-md-8">
              <label class="form-label"
                >Allergies / avoid (comma separated)</label
              >
              <input
                type="text"
                class="form-control"
              ...
              />
              <div class="form-text">
                Saved: {{ form.allergies.join(", ") || "None" }}
              </div>
            </div>
      ...
      <!-- 4) TRAINING -->
      <div class="card mb-4">
        <div class="card-header fw-bold">4) Training preferences</div>
        <div class="card-body">
          <div class="row g-3">
            <div class="col-12 col-md-4">
              <label class="form-label"
                >Primary goal <span class="text-danger">*</span></label
              >
              <select
                class="form-select"
              ...
              <div v-if="errors.goal" class="invalid-feedback d-block">
                {{ errors.goal }}
              </div>
            </div>
            <div class="col-6 col-md-2">
            ...
            <div class="col-12">
              ...
              <input
                class="form-control"
                placeholder="e.g., knee—no jumping"
      ...
      <!-- 5) SAFETY -->
      <div class="card mb-4">
        <div class="card-header fw-bold">5) Safety flags</div>
        <div class="card-body">
          <div class="d-flex flex-wrap gap-3">
      ...
      <!-- 6) COACHING -->
      <div class="card mb-4">
        <div class="card-header fw-bold">6) Coaching</div>
        <div class="card-body">
          <div class="row g-3 align-items-center">
            <div class="col-12 col-md-6">
              ...
              <input
                ...
                step="0.25"
                class="form-range"
                v-model.number="form.weekly_loss"
              />
              <div class="form-text">
                Current: {{ form.weekly_loss.toFixed(2) }} kg/week
              </div>
            </div>
            <div class="col-6 col-md-3">
              ...
              <div class="form-check form-switch">
                <input
                  class="form-check-input"
                  type="checkbox"
                  v-model="form.protein_high"
                />
                <label class="form-check-label">{{
                  form.protein_high ? "High" : "Normal"
                }}</label>
              </div>
            </div>
            <div class="col-6 col-md-3">
              ...
              <input
                ...
                step="0.1"
                class="form-range"
                v-model.number="form.strictness"
              />
      ...
      <!-- 7) REMINDERS -->
      <div class="card mb-4">
        <div class="card-header fw-bold">7) Reminders</div>
        <div class="card-body">
          <div class="row g-3">
            <div class="col-12 col-md-4">
            ...
            <div class="col-6 col-md-4">
              <div class="form-check mt-4">
                <input
                  class="form-check-input"
                  type="checkbox"
                  v-model="form.reminders.water"
                  id="rWater"
                />
                <label class="form-check-label" for="rWater"
    ...
    <!-- SUBMITTED RECORDS -->
    <div v-if="submitted.length" class="mt-5">
...
const weight_current_ui = ref(null); // kg or lb depending on units
...
function setUnits(u) {
  ...
  if (u === "imperial") {
    ...
    weight_current_ui.value = form.value.weight_current_kg
      ? +(form.value.weight_current_kg * 2.20462).toFixed(1)
      : null;
    weight_goal_ui.value = form.value.weight_goal_kg
      ? +(form.value.weight_goal_kg * 2.20462).toFixed(1)
      : null;
  } else {
    // ft/in -> cm
...
/* keep UI mirrors in metric mode */
watch(
  () => form.value.weight_current_kg,
  (v) => {
    if (units.value === "metric") weight_current_ui.value = v;
  }
);
watch(
  () => form.value.weight_goal_kg,
  (v) => {
    if (units.value === "metric") weight_goal_ui.value = v;
  }
);
...
const paceText = computed(() => {
  ...
  const days =
    (new Date(form.value.target_date) - new Date()) / (1000 * 3600 * 24);
  if (days <= 0) return "";
  const weeks = days / 7;
...
const validateSex = (strict) => {
  errors.value.sex = form.value.sex
    ? null
    : strict
...
const validateDOB = (strict) => {
  ...
  errors.value.dob =
    a && a >= 16 && a <= 80
      ? null
      : strict
      ? "Enter a valid DOB (16–80)"
      : null;
};
function validateHeight(strict) {
  const h = form.value.height_cm;
  errors.value.height =
    h >= 120 && h <= 210 ? null : strict ? "Height must be 120–210 cm" : null;
}
function validateWeights(strict) {
  ...
  errors.value.wtNow = okNow
    ? null
    : strict
    ? "Current weight must be 35–250 kg"
    : null;
  errors.value.wtGoal = okGoal
    ? null
    : strict
    ? "Goal weight must be 35–250 kg"
    : null;
  if (!errors.value.wtNow && !errors.value.wtGoal) {
    if (goal >= now)
      errors.value.wtGoal = strict
        ? "Goal must be lower than current"
        : errors.value.wtGoal;
  }
}
function validateTargetDate(strict) {
  if (!form.value.target_date) {
    errors.value.targetDate = null;
    return;
  }
  const ok =
    new Date(form.value.target_date) >= new Date(new Date().toDateString());
  errors.value.targetDate = ok
    ? null
    : strict
    ? "Target date must be today or later"
    : null;
}
const validateActivity = (strict) => {
  errors.value.activity = form.value.activity
    ? null
    : strict
    ? "Select an activity level"
    : null;
};
const validateGoal = (strict) => {
  errors.value.goal = form.value.goal
    ? null
    : strict
...
function kg(v) {
  return v ?? v === 0 ? `${Number(v).toFixed(0)} kg` : "—";
}
...
function formatProfile(row) {
  ...
  const weights =
    p.weight_current_kg && p.weight_goal_kg
      ? `${kg(p.weight_current_kg)} → ${kg(p.weight_goal_kg)}`
      : p.weight_current_kg
      ? kg(p.weight_current_kg)
      : "—";
...
function formatTraining(row) {
  ...
  const eq =
    t.equipment && t.equipment.length ? t.equipment.join(", ") : "none";
...
function formatNutrition(row) {
  ...
  const avoid =
    n.allergies && n.allergies.length ? n.allergies.join(", ") : "—";
...
function formatCoaching(row) {
  ...
  const pace =
    c.weekly_loss_kg || c.weekly_loss_kg === 0
      ? `${Number(c.weekly_loss_kg).toFixed(2)} kg/wk`
      : "—";
...
function submitForm() {
  ...
  // build the JSON you can send to AI later
  const payload = {
    profile: {
      sex: form.value.sex,
      dob: form.value.dob,
      height_cm: form.value.height_cm,
      weight_current_kg: form.value.weight_current_kg,
      weight_goal_kg: form.value.weight_goal_kg,
    ...
    nutrition: {
      diet_style: form.value.diet_style,
    ...
    coaching: {
      weekly_loss_kg: form.value.weekly_loss,
      protein_high: form.value.protein_high,
      strictness: form.value.strictness,
    },
    reminders: { ...form.value.reminders },
  };
  submitted.value.push(payload);
  clearForm();
}

function clearForm() {
  // keep units selection; reset fields
  const tz = form.value.reminders.timezone;
  form.value = {
    sex: "",
    dob: "",
    height_cm: null,
    ...
    protein_high: false,
    strictness: 0.6,
    reminders: { weigh_in: "", water: false, timezone: tz },
  };
  allergyInput.value = "";
  height_ft.value = null;
  height_in.value = null;
  weight_current_ui.value = null;
  weight_goal_ui.value = null;
